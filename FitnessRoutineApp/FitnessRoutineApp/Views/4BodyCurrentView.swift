...
private extension BodyCurrentView {
    ...
    var headerSection: some View {
        VStack(spacing: 20) {
            ...
            VStack(spacing: 12) {
                ...
                Text("Help us understand your starting point to create the perfect fitness plan for your journey")
                    .font(.system(size: 16))
    ...
    var nextButtonSection: some View {
        VStack {
            ...
            NavigationLink(
                destination: DesiredBodyView(progressViewModel: progressViewModel),
