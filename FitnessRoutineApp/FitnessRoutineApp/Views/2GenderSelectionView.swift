    ...
    var headerSection: some View {
        VStack(spacing: 20) {
            ...
            VStack(spacing: 12) {
                ...
                Text("This helps us personalize your fitness experience and provide accurate calorie calculations")
                    .font(.system(size: 16))
...
struct GenderOptionCard: View {
    ...
    var body: some View {
        Button(action: action) {
            ...
            .shadow(
                color: isSelected ? genderInfo.color.opacity(0.3) : Color.clear,
